...
- [ ] **Trade Route Network** - Basic Silk Road main route with key nodes
  ...
  - [ ] Create `common/trade_routes/silk_road_main.txt` defining primary Silk Road path
    ...
    - [ ] Set standard trade flow capacity for the main route
...
- [ ] **Trade Node System** - Essential trade hubs with simple connection rules
  ...
  - [ ] Create `common/trade_nodes/silk_road_nodes.txt` with key trade centers
    - [ ] Define core node data structure with county/province connections
